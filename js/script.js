  ...
  item.addEventListener('click', function() {
      ...
      switch(partnerId) {
          case "1":
            ...
            <p>옥준원 변호사는 사법연수원 수료(15기) 후, 전국 각 지방 및 고등검찰청에서 검사 및 부장검사로 만 23년간 근무 후 퇴직하였고, 이후 변호사로 개업하여 법무법인(유한) 에이스에서 만 12년간 변호사로 재직하였습니다. 검찰에 재직하는 동안 특수부와 공안부에도 근무하였으나 주로 형사부와 조사부에 근무하면서 다양한 형사사건을 수사하였고, 조직범죄, 기업형경제범죄, 다단계사기범죄, 탈세범죄 등 복잡다단한 고소사건을 수사하였습니다.</p>
            `;
              break;
          case "2":
          content = `
          ...
          <p>송범준 변호사의 주요 업무는 해외투자 및 기업인수합병(M&A) 관련 자문, 특허 침해, IP 분쟁, 가상화폐 관련 민형사 자문 및 송무입니다.<br><br>관련 분야: 해외투자, 인수합병, 기업법무, 수사대응, 가상화폐, 지적재산권(IP 및 상표권) 관련 민형사 자문 및 송무
          </p>
          `;
            break;
          case "5":
          ...
          <h2>장현경</h2>
          <div class="position-title">구성원변호사</div>
          <p>장현경 변호사는 대한변호사협회에 형사법과 손해배상 전문 변호사로 등록되어 있으면서, 검찰총장 출신 등이 포진하고 있는 법무법인 대건에서 파트너 변호사로 근무하며 다수의 형사사건과 민사 사건을 성공적으로 처리한 바 있습니다. 또한, 대기업 대금청구 사건 및 하도급법 등과 관련된 다수의 공정거래위원회 사건을 담당한 바 있으며, 2014년 중앙선거관리위원회에서 진행한 선거용어사전 편찬에 참여하고 2018년 서울에서 열린 세계헌법대회 조직위원회에도 활동하였을 정도로 공법 분야에서도 그 역량을 보이고 있을 뿐만 아니라, 현재 투자회사의 준법감시인 역할을 겸하면서 그 전문성을 광범위한 분야로 넓히고 있습니다.</p>
          `;
            break;
          case "6":
          content = `
          ...
          <h2>옥민석</h2>
          <div class="position-title">구성원변호사</div>
          <p>옥민석 변호사는 제1보병사단 헌병대 수사과, 성범죄 전문 로펌에서 근무하였습니다.<br><br>옥민석 변호사는 다수의 성범죄, 음주운전 사건을 해결하며 얻은 경험과 노하우를 바탕으로 형사법 분야에서 최상의 법률서비스를 제공하고 있습니다.<br><br>옥민석 변호사는 ‘N번방 사건’, ‘박사방 사건’ 등과 같은 아동·청소년의성보호에관한법률위반 사건, ‘윤드로저 사건’ 등과 같은 성폭력범죄의처벌등에관한특례법위반 사건, 강제추행, 강간 등 사건을 연이어 성공적으로 해결하며 성범죄 분야에서 그 전문성을 인정받고 있습니다.<br><br>옥민석 변호사는 ‘윤창호 사건’ 이후 음주운전에 대한 처벌이 강화된 상황에서 벌금형 등 선처를 이끌어내며 음주운전 사건에서도 그 두각을 나타내고 있습니다.<br><br>옥민석 변호사는 소비자들의 선택을 받아 ‘2021 KCA 우수 전문인 어워즈’를 수상하였습니다.
          </p>
          `;
            break;
          case "8":
          ...
          <h2>이창우</h2>
          <div class="position-title">구성원변호사</div>
          <p>이창우 변호사는 법무법인 중원에서 법원장, 부장판사, 검사 출신의 변호사들과 함께 민사, 형사, 행정, 집행 등 다양한 유형의 소송과 상장기업, 지방자치단체, 사립학교법인, 교육청, 국세청 등에 대한 자문 업무를 수행하면서 얻은 전문 지식을 바탕으로 의뢰인들의 권익을 보호하기 위하여 최적화된 법률서비스를 제공하고 있습니다.</p>
          `;
            break;
            case "9":
            content = `
            <h2>강지웅</h2>
            <div class="position-title">구성원변호사</div>
            <p>강지웅 변호사의 주된 업무 분야는 명예훼손, 모욕 등의 사회범죄에 관한 형사사건 및 이혼(재산분할, 상간자 소송), 상속(상속재산분할, 후견인 지정) 등의 가사사건 업무입니다. 이 외에도, 다수의 부동산 분쟁과 손해배상 소송 등의 민사사건을 두루 수행하였고, 마약, 성범죄, 사기, 횡령 등의 형사사건을 통해 의뢰인의 권익보호에 앞장서 왔으며, 음주운전과 관련한 형사 및 관련 행정소송에서 뚜렷한 성과를 보여왔습니다.</p>
            `;
              break;
              case "10":
              content = `
              <h2>이동현</h2>
              <div class="position-title">구성원변호사</div>
              <p>대한변호사협회학교폭력전문변호사, 대한변호사협회형사전문변호사<br><br>강릉고등학교, 법과대학법학과(수석졸업), ROTC 보병장교전역, 법학전문대학원(차석입학), 중국소주대학교왕건법학원교환학생, 변호사시험합격, 법무법인(유한) 태평양인턴<br><br>前) 신영증권사내변호사 前) 서울자양초등학교학교폭력대책위원회위원 前) 서울중마초등학교학교폭력대책위원회위원 前) 서울성동광진교육지원청학교폭력대책심의위원회위원 前) 김포교육지원청학교폭력대책심의위원회위원<br><br>現) 서울시교육청행정심판위원회위원 現) 서울특별시교육청성희롱·성폭력사안처리지원단자문·심의위원 現) 광주하남교육지원청학교폭력대책심의위원회위원장 現) 안양과천교육지원청학교폭력대책심의위원회위원 現) 군포의왕교육지원청학교폭력대책심의위원회위원 現) 안양만안경찰서여성청소년과선도심사위원회전문위원 現) 서울자양초등학교교권보호위원회외부위원 現) 서울자양초등학교성희롱•성폭력외부전문위원 現) 서울자양초등학교변호사명예교사 現) 서울매헌초등학교변호사명예교사 現) 서울지방변호사회미래인재지원단위원 現) 서울지방변호사회미래인재특별위원회위원 現) 서울지방변호사회법제사법위원회위원 現) 대한변호사협회입법특별위원회위원 現) 강남경찰서경찰발전협의회위원 現) 관악경찰서경찰발전협의회회원 現) 한국법학원대의원 現) 서울금융고등학교성고충심의위원회위원 現) 합격의법학원형사법강사(변호사시험강의) 現) 동국대학교사범대학부속여자고등학교고문변호사 現) 길음중학교고문변호사 現) 문정중학교고문변호사 現) 방학중학교고문변호사 現) 명일중학교고문변호사 現) 성일중학교고문변호사 現) 신남중학교고문변호사 現) 동국대학교사범대학부속여자중학교고문변호사 現) 신원초등학교고문변호사 現) 장안초등학교고문변호사 現) 매헌초등학교고문변호사
              </p>
              `;
                break;
                case "11":
                ...
                `;
                  ...
                  <h2>김석훈</h2>
                  <div class="position-title">변호사</div>
                  <p>김석훈 변호사는 연세대학교 경영학과와 동 대학교 법학과 일반대학원(석사, 민법전공)을 졸업하였고, 헌법재판소에서 실무수습을 한 경력이 있습니다.<br><br>현재 에스제이파트너스에서 행정심판, 행정소송 등 행정사건과 이혼, 상속 등 가사사건과 일반 민·형사 사건을 담당하고 있습니다.
</p>
                  `;
                    break;
                    case "13":
                    ...
                    <h2>박재성</h2>
                    <div class="position-title">변호사</div>
                    <p>박재성 변호사는 서울대학교 법학부를 졸업하고 변호사시험에 합격한 뒤, 에스제이파트너스에서 민사, 형사, 행정, 노무, 의료분쟁, 병원 및 기업자문 등의 다양한 업무를 수행하고 있습니다.<br><br>박재성 변호사는 현재 서울지방변호사회 형사당직변호사, 대한병원협회 준법지원인, 공군검찰부 국선변호인(피해자) 등으로 활동하고 있으며, 자문 및 송무전문 변호사로서 다수의 업무를 수행하면서 쌓아온 전문성과 사안의 핵심을 정확하게 파악하는 능력을 바탕으로 고객의 모든 법률적 고민에 대하여 명쾌하면서도 최선의 답을 드리고자 노력하는 변호사입니다.</p>
                    `;
                      break;
                      case "14":
                      content = `
                      <h2>이정석</h2>
                      <div class="position-title">변호사</div>
                      <p>이정석 변호사는 연세대학교 법과대학을 졸업하였으며, 대한변호사협회 등록 형사법 전문변호사입니다.<br><br>주로 형사사건과 기업자문을 담당하고 있으며, 서울서부지방법원 국선변호인, 서울지방변호사협회 형사당직변호사, 하남경찰서 수사자문변호사로도 활동중입니다.</p>
                      `;
                        break;
                        case "15":
                        content = `
                        ...
                        `;
                          ...
                          `;
                            ...
                            <h2>정지수</h2>
                            <div class="position-title">변호사</div>
                            <p>정지수 변호사는 전주 상산고등학교와 고려대학교를 졸업하였고, 부산지방법원과 검찰에서 실무수습을 한 경력이 있습니다. 현재 에스제이파트너스의 소속 변호사로서 가상화폐 관련 민형사 자문 및 송무, 기업법무, 인수합병, 이혼/상속 업무를 수행하고 있습니다.</p>
                            `;
                              break;
                              case "18":
                              content = `
                              <h2>최형기</h2>
                              <div class="position-title">변호사</div>
                              <p>[주요업무분야] 중소벤처기업부 출신의 중소기업 및 소상공인 법률 자문 및 관련 송무 수행, 관련 상가 부동산 및 임대차 사건 수행, 관련 행정소송 사건 수행, 기타 민형사 사건 수행<br><br>[경력] 의정부지방법원 인턴, 의정부지방검찰청 인턴, 법무법인 동하, 중소벤처기업부, (현) 법무법인(유한) 에스제이파트너스 소속변호사<br><br>[학력] 의정부고등학교, 성균관대학교 법과대학, 충남대학교 법학전문대학원
                              </p>
                              `;
                                break;
                                case "19":
                                content = `
                                <h2>남준규</h2>
                                <div class="position-title">외국변호사(D.C.)</div>
                                <p>남준규 외국변호사는(미국, 워싱턴 D.C.), 공공기관, 기업 및 로펌 등을 거치면서 기업의 투자, M&A 등과 관련된 업무를 성실하게 수행해 왔습니다. 다양한 국내외 경험을 바탕으로 국내/해외 투자, 국제상거래, M&A, JV, 라이센싱, 국제중재 등과 같이 기업의 거래 및 운영에 관한 자문 업무를 주로 수행하고 있습니다.<br><br>Junkyu Nam (JK) is a foreign attorney (Washington D.C.) in SJ Partners Law Office. His practice focuses on Corporate law, M&A, Domestic and Cross-border Investment, International commerce, JV, licensing. Prior to joining Song Bo, Junkyu (JK) had worked pu</p>
                                `;
                                  break;
                                  case "20":
                                  content = `
